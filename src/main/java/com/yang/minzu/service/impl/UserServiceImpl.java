...
import com.yang.minzu.mapper.UserMapper;
import com.yang.minzu.service.UserService;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegisterMail(String email,HttpServletRequest request){
        ...
        //将验证码 和 过期时间更新到数据库
        request.getSession().setAttribute(UserConstant.USER_REGISTER_CODE, verifyCode);
        request.getSession().setAttribute(UserConstant.USER_REGISTER_CODE_OUTDATE, outDate);
        ...
        try {
            ...
            mimeMessageHelper.setFrom(UserConstant.MAIL_FROM);
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String email, String userCode, HttpServletRequest request) {
        ...
        String verifyCode = (String) request.getSession().getAttribute(UserConstant.USER_REGISTER_CODE);
        Date outDate = (Date) request.getSession().getAttribute(UserConstant.USER_REGISTER_CODE_OUTDATE);
        Date date = new Date();
        ...
        request.getSession().removeAttribute(UserConstant.USER_REGISTER_CODE);
        request.getSession().removeAttribute(UserConstant.USER_REGISTER_CODE_OUTDATE);
        return user.getId();
    }
